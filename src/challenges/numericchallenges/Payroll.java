...
//Descrição do desafio ao final do código
...
public class Payroll {
    ...
    public static void main(String[] args) {
        ...
        int numeroTrabalhador = reader.nextInt();
        int horasTrabalhadas = reader.nextInt();
        Double salarioPorHora = reader.nextDouble();

        System.out.println("NUMBER = "+numeroTrabalhador);
        System.out.println("SALARY = U$ "+String.format("%.2f",salarioPorHora * horasTrabalhadas));
        reader.close();
    }
}
...
Entrada
Você receverá 2 números inteiros e 1 número com duas casas decimais, representando o número, quantidade de horas
trabalhadas e o valor que o funcionário recebe por hora trabalhada.

Saída
Exiba o número e o salário do colaborador, conforme exemplo abaixo, com um espaço em branco antes e depois da
